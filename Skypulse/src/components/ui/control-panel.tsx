...
export function ControlPanel({
  ...
  useEffect(() => {
    ...
    window.addEventListener("skypulse:open-search", handleOpenSearch);
    return () =>
      window.removeEventListener("skypulse:open-search", handleOpenSearch);
  }, []);
      ...
      <div className="space-y-0.5 p-3 pt-1">
        ...
        <div className="flex items-center justify-between px-3 py-2.5">
          <div className="flex items-center gap-2.5 text-white/50">
            ...
            <div>
              <div className="text-[13px] font-medium text-white/75">Altitude unit</div>
              <div className="text-[11px] text-white/40">Feet or meters display</div>
            </div>
          </div>
          <div className="flex rounded-lg bg-white/5 p-0.5">
            <button
              onClick={() => update("altitudeUnit", "feet")}
            ...
            <button
              onClick={() => update("altitudeUnit", "meters")}
              className={`px-2.5 py-1 text-[12px] font-medium rounded-md transition-colors ${
